\hypertarget{15in_2include_2okapi_2api_2util_2logging_8hpp_source}{}\doxysection{logging.\+hpp}
\label{15in_2include_2okapi_2api_2util_2logging_8hpp_source}\index{15in/include/okapi/api/util/logging.hpp@{15in/include/okapi/api/util/logging.hpp}}
...
\DoxyCodeLine{30 \textcolor{keyword}{class }\mbox{\hyperlink{classokapi_1_1_logger}{Logger}} \{}
...
\DoxyCodeLine{33     debug = 4, }
\DoxyCodeLine{34     info = 3,  }
\DoxyCodeLine{35     warn = 2,  }
\DoxyCodeLine{36     error = 1, }
\DoxyCodeLine{37     off = 0    }
\DoxyCodeLine{38   \};}
\DoxyCodeLine{39 }
...
\DoxyCodeLine{72   \}}
\DoxyCodeLine{73 }
\DoxyCodeLine{74   \textcolor{keyword}{template} <\textcolor{keyword}{typename} T> \textcolor{keywordtype}{void} debug(T ilazyMessage) \textcolor{keyword}{noexcept} \{}
...
\DoxyCodeLine{87   \}}
\DoxyCodeLine{88 }
\DoxyCodeLine{89   \textcolor{keyword}{template} <\textcolor{keyword}{typename} T> \textcolor{keywordtype}{void} info(T ilazyMessage) \textcolor{keyword}{noexcept} \{}
...
\DoxyCodeLine{102   \}}
\DoxyCodeLine{103 }
\DoxyCodeLine{104   \textcolor{keyword}{template} <\textcolor{keyword}{typename} T> \textcolor{keywordtype}{void} warn(T ilazyMessage) \textcolor{keyword}{noexcept} \{}
...
\DoxyCodeLine{117   \}}
\DoxyCodeLine{118 }
\DoxyCodeLine{119   \textcolor{keyword}{template} <\textcolor{keyword}{typename} T> \textcolor{keywordtype}{void} error(T ilazyMessage) \textcolor{keyword}{noexcept} \{}
...
\DoxyCodeLine{168     \}}
\DoxyCodeLine{169   \}}
\DoxyCodeLine{170   \mbox{\hyperlink{structokapi_1_1_default_logger_initializer}{\string~DefaultLoggerInitializer}}() \{}
...
\DoxyCodeLine{189 \};}
\DoxyCodeLine{190 }
\DoxyCodeLine{191 \textcolor{keyword}{static} \mbox{\hyperlink{structokapi_1_1_default_logger_initializer}{DefaultLoggerInitializer}} defaultLoggerInitializer; \textcolor{comment}{// NOLINT(cert-\/err58-\/cpp)}}
