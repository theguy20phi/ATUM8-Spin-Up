\hypertarget{15in_2include_2okapi_2api_2control_2iterative_2iterative_vel_pid_controller_8hpp_source}{}\doxysection{iterative\+Vel\+Pid\+Controller.\+hpp}
\label{15in_2include_2okapi_2api_2control_2iterative_2iterative_vel_pid_controller_8hpp_source}\index{15in/include/okapi/api/control/iterative/iterativeVelPidController.hpp@{15in/include/okapi/api/control/iterative/iterativeVelPidController.hpp}}
...
\DoxyCodeLine{16 \textcolor{keyword}{class }\mbox{\hyperlink{classokapi_1_1_iterative_vel_p_i_d_controller}{IterativeVelPIDController}} : \textcolor{keyword}{public} \mbox{\hyperlink{classokapi_1_1_iterative_velocity_controller}{IterativeVelocityController}}<double, double> \{}
\DoxyCodeLine{17   \textcolor{keyword}{public}:}
\DoxyCodeLine{18   \textcolor{keyword}{struct }\mbox{\hyperlink{structokapi_1_1_iterative_vel_p_i_d_controller_1_1_gains}{Gains}} \{}
...
\DoxyCodeLine{23 }
\DoxyCodeLine{24     \textcolor{keywordtype}{bool} operator==(\textcolor{keyword}{const} \mbox{\hyperlink{structokapi_1_1_iterative_vel_p_i_d_controller_1_1_gains}{Gains}} \&rhs) \textcolor{keyword}{const};}
\DoxyCodeLine{25     \textcolor{keywordtype}{bool} operator!=(\textcolor{keyword}{const} \mbox{\hyperlink{structokapi_1_1_iterative_vel_p_i_d_controller_1_1_gains}{Gains}} \&rhs) \textcolor{keyword}{const};}
\DoxyCodeLine{26   \};}
\DoxyCodeLine{27 }
