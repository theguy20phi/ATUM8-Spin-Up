\hypertarget{atum_2include_2okapi_2api_2control_2iterative_2iterative_pos_pid_controller_8hpp_source}{}\doxysection{iterative\+Pos\+Pid\+Controller.\+hpp}
\label{atum_2include_2okapi_2api_2control_2iterative_2iterative_pos_pid_controller_8hpp_source}\index{atum/include/okapi/api/control/iterative/iterativePosPidController.hpp@{atum/include/okapi/api/control/iterative/iterativePosPidController.hpp}}
...
\DoxyCodeLine{20 \textcolor{keyword}{class }IterativePosPIDController : \textcolor{keyword}{public} IterativePositionController<double, double> \{}
\DoxyCodeLine{21   \textcolor{keyword}{public}:}
\DoxyCodeLine{22   \textcolor{keyword}{struct }Gains \{}
...
\DoxyCodeLine{27 }
\DoxyCodeLine{28     \textcolor{keywordtype}{bool} operator==(\textcolor{keyword}{const} Gains \&rhs) \textcolor{keyword}{const};}
\DoxyCodeLine{29     \textcolor{keywordtype}{bool} operator!=(\textcolor{keyword}{const} Gains \&rhs) \textcolor{keyword}{const};}
\DoxyCodeLine{30   \};}
\DoxyCodeLine{31 }
