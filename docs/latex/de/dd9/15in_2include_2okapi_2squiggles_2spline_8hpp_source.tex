\hypertarget{15in_2include_2okapi_2squiggles_2spline_8hpp_source}{}\doxysection{spline.\+hpp}
\label{15in_2include_2okapi_2squiggles_2spline_8hpp_source}\index{15in/include/okapi/squiggles/spline.hpp@{15in/include/okapi/squiggles/spline.hpp}}
...
\DoxyCodeLine{22 \textcolor{keyword}{class }\mbox{\hyperlink{classsquiggles_1_1_spline_generator}{SplineGenerator}} \{}
...
\DoxyCodeLine{115     \}}
\DoxyCodeLine{116 }
\DoxyCodeLine{117     \mbox{\hyperlink{classsquiggles_1_1_pose}{Pose}} pose;}
\DoxyCodeLine{118     \textcolor{keywordtype}{double} curvature;}
\DoxyCodeLine{119   \};}
\DoxyCodeLine{120 }
\DoxyCodeLine{126   \textcolor{keyword}{struct }\mbox{\hyperlink{structsquiggles_1_1_spline_generator_1_1_generated_vector}{GeneratedVector}} \{}
\DoxyCodeLine{127     \mbox{\hyperlink{structsquiggles_1_1_spline_generator_1_1_generated_vector}{GeneratedVector}}(\mbox{\hyperlink{structsquiggles_1_1_spline_generator_1_1_generated_point}{GeneratedPoint}} ipoint,}
...
\DoxyCodeLine{132 }
\DoxyCodeLine{133     \mbox{\hyperlink{structsquiggles_1_1_spline_generator_1_1_generated_point}{GeneratedPoint}} point;}
...
\DoxyCodeLine{144   \};}
\DoxyCodeLine{145 }
\DoxyCodeLine{146   std::vector<GeneratedVector> gen\_single\_raw\_path(\mbox{\hyperlink{classsquiggles_1_1_control_vector}{ControlVector}} start,}
\DoxyCodeLine{147                                                    \mbox{\hyperlink{classsquiggles_1_1_control_vector}{ControlVector}} end,}
...
\DoxyCodeLine{179 }
\DoxyCodeLine{180     \mbox{\hyperlink{structsquiggles_1_1_spline_generator_1_1_constrained_state}{ConstrainedState}}() = \textcolor{keywordflow}{default};}
\DoxyCodeLine{181 }
